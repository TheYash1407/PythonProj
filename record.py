...
class ScreenRecorder:
    ...
    def __init__(self, width, height, fps, out_file='video.avi'):
        ...
        self.video = cv.VideoWriter(out_file, four_cc, float(fps), (width, height))
    ...
    def capture_frame(self, surf):
        ...
        pixels = cv.rotate(pygame.surfarray.pixels3d(surf), cv.ROTATE_90_CLOCKWISE)
        pixels = cv.flip(pixels, 1)
